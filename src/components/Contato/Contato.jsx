...
export default function Contato() {
  ...
  // Função para registrar o evento no GA4 e a conversão no Google Ads
  const gtag_report_conversion = (url, cidade) => {
    let opened = false;
    ...
    if (typeof window !== "undefined" && typeof window.gtag === "function") {
      ...
      // Evento personalizado do Google Analytics 4
      ...
      // Garante abertura do WhatsApp caso o callback não seja executado
    ...
    <div className={styles.contatoContainer}>
      ...
      <section className={styles.conteudoSection}>
        ...
        <p className={styles.subtituloSecao}>
          Escolha a sua cidade abaixo para falar diretamente com o guincho de plantão:
        </p>
            ...
            <a
              ...
              onClick={(e) => {
                ...
                gtag_report_conversion(
                  `https://wa.me/${numeroWhats}?text=Olá! Preciso de um guincho em Londrina.`,
                  "Londrina"
                );
              }}
          ...
          <div className={styles.cidadeCard}>
            ...
            <a
              ...
              onClick={(e) => {
                e.preventDefault();
                gtag_report_conversion(
                  `https://wa.me/${numeroWhats}?text=Olá! Preciso de um guincho em Cambé.`,
                  "Cambé"
                );
              }}
              className={styles.botaoWhatsCidade}
          ...
          <div className={styles.cidadeCard}>
            ...
            <a
              ...
              onClick={(e) => {
                e.preventDefault();
                gtag_report_conversion(
                  `https://wa.me/${numeroWhats}?text=Olá! Preciso de um guincho em Ibiporã.`,
                  "Ibiporã"
                );
              }}
              className={styles.botaoWhatsCidade}
